...
public class SkillraryHomePage {
	...
	@FindBy(xpath = "//ul[contains(@class,'dropdown-menu')]/descendant::a[contains(text(),' SkillRary Demo APP')]")
	private WebElement skillraryDemoAppLink;
	
	/*@FindBy(xpath="ul[contains(@class,'home_menu')]/li[1]")
	private WebElement language;
	
	@FindBy(xpath="//ul[contains(@class,'home_menu')]/desecdent::A[text()='English']")
